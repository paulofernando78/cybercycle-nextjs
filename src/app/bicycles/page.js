    ...
    <>
      ...
      <div className={styles["bicycle-container"]}>
        <div className={`line-break ${styles["card"]}`}>
          <Image src={velocityV3} alt="Velocity Z2" layout="intrinsic" className={styles["image"]}/>
          <h3>Velocity Z2</h3>
        ...
        <div className={`line-break ${styles["card"]}`}>
          <Image src={vortexV9} alt="Vortex V9" layout="intrinsic" className={styles["image"]}/>
          <h3>Vortex V9</h3>
          <p className={styles["paragraph"]}>
        ...
        <div className={`line-break ${styles["card"]}`}>
          <Image src={quantumX1} alt="Quantum X1" layout="intrinsic" className={styles["image"]}/>
          <h3>Quantum X1</h3>
          <p className={styles["paragraph"]}>
